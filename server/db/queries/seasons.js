...
const getSeasonResults = (id) => {
	return db.query(`
  SELECT u.id as user_id, u.human, u.first_name, u.last_name, u.initials, u.profile_image, r.id, r.dnf, r.fastest_lap, r.sprint, r.position, r.created_at, t.team_name, tr.name
  FROM race_results r
